...
class SupermarketApp:
    ...
    def run(self):
        ...
        city_options = self.data_handler.df['City'].unique().tolist()
        gender_options = self.data_handler.df['Gender'].unique().tolist()
        customer_options = self.data_handler.df['Customer type'].unique().tolist()
        ...
        df_filtered = self.data_handler.filter_data(selected_city, selected_gender, selected_customer)
        chart_builder = ChartBuilder(df_filtered)
